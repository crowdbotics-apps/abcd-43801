"""
Django settings for abcd_43801 project.
...
WSGI_APPLICATION = 'abcd_43801.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abcd_43801 API",
    "DESCRIPTION": "API documentation for abcd_43801 App",
    "VERSION": "v1",
}
